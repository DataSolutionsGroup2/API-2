            ...
            <nav className="bg-white border-gray-200 bg-gradient-to-r from-[#3241F0] to-[#818380] bg-[length:500%_10%]">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Editor</span>
                    </a>
                ...
                <div className="max-w-screen-xl px-4 py-3 mx-auto">
                    <div className="flex items-center">
                        <ul className="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                            ...
                            <li>
                                <a href="#" className="text-gray-900 dark:text-white hover:underline">Tabela</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-900 dark:text-white hover:underline">Estatisticas</a>
                            </li>
