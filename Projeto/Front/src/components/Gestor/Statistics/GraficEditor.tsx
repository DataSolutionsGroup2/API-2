...
const GraficEditor = () => {
  ...
  useEffect(() => {
    if (data.length > 0) {
      ...
      const cityData: Record<string, GraficEditorProps[]> = {};
      const colorPalette = [
        "#FF5733", "#33FF57", "#3357FF", "#FF33A6", "#A633FF", "#33FFDA", "#FF8C33", "#57FF33"
      ];
        ...
        const option: echarts.EChartsOption = {
          ...
          series: [
            ...
            },
            {
              ...
              data: finalizadoData,
              itemStyle: {
                color: ({ dataIndex }) => colorPalette[dataIndex % colorPalette.length],
              },
            },
            {
              name: "Sem Atribuição",
  ...
  return (
    <div className="flex flex-col mt-10 ml-[50px] h-auto p-4 mb-4">
      <div id="main-Atibaia" style={{ width: "1000px", height: "400px" }}></div>
      <div id="main-Cruzeiro" style={{ width: "1000px", height: "400px" }}></div>
      <div id="main-Taubate" style={{ width: "1000px", height: "400px" }}></div>
    </div>
  );
};
