          ...
          <tbody>
            {regionData && regionData?.map((item, index) =>(
              <tr key={item.id} className={`${index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-200'}`}>
                ...
                <td className="py-2 px-4 text-center flex-wrap">{item.atribuicao}</td>
                <td className="py-2 px-4 text-center flex-wrap">{item.status}</td>
                <td className="py-2 px-4 text-center flex-wrap">{item.validacao}</td>
                <td className="py-2 px-4 text-center flex-wrap">{item.status_val}</td>
                <td className="py-2 px-4 text-center flex-wrap">{item.area_km2}</td>
              </tr>
            ))}
          </tbody>
        </table>
